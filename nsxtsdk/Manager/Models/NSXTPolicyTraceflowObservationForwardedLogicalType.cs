...
namespace nsxtsdk.ManagerModels
{
    ...
    {
        public NSXTPolicyTraceflowObservationForwardedLogicalType()
        {
        }
        /// <summary>
        ...
        [NSXTProperty(IsRequired: false, Description: @"The path of the component that forwarded the traceflow packet")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"The path of the segment port or router port through which the traceflow packet was forwarded")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"The path of the destination component to which the traceflow packet was forwarded")]
