...
namespace nsxtsdk.ManagerModels
{
    ...
    public class NSXTStandardHostSwitchType 
    {
        ...
        /// <summary>
        /// IPs can come from either a static IP pool or an explicitly specified IP list or DHCP. In case a list of IP is specified,
        /// the number of IPs provided should be sufficient as per teaming policy associated with host switch uplink profile.
        /// </summary>
        [JsonProperty(PropertyName = "ip_assignment_spec")]
        [NSXTProperty(IsRequired: false, Description: @"IPs can come from either a static IP pool or an explicitly specified IP list or DHCP. In case a list of IP is specified, the number of IPs provided should be sufficient as per teaming policy associated with host switch uplink profile.")]
        ...
        /// supported by the transport node, the corresponding default profile will be bound to the host switch.
        /// </summary>
        [JsonProperty(PropertyName = "host_switch_profile_ids")]
        [NSXTProperty(IsRequired: false, Description: @"Host switch profiles bound to this host switch. If a profile ID is not provided for any HostSwitchProfileType that is supported by the transport node, the corresponding default profile will be bound to the host switch.")]
