...
namespace nsxtsdk.ManagerModels
{
    ...
    {
        public NSXTPublicClientInfoType()
        {
        }
        /// <summary>
        ...
        [NSXTProperty(IsRequired: true, Description: @"The org id for this client-id, typically a UUID.")]
        ...
        [NSXTProperty(IsRequired: true, Description: @"The set of redirect URI&apos;s configured for this client_id.")]
        [System.ComponentModel.DataAnnotations.Required]
        ...
        [NSXTProperty(IsRequired: true, Description: @"The client-id to use with CSP, identified with base_url.")]
        [System.ComponentModel.DataAnnotations.Required]
        ...
        [NSXTProperty(IsRequired: true, Description: @"The symbolic org id for enterprise admins.")]
        [System.ComponentModel.DataAnnotations.Required]
        ...
        [NSXTProperty(IsRequired: true, Description: @"The symbolic org id SRE (Site Reliability Engineer).")]
        [System.ComponentModel.DataAnnotations.Required]
        ...
        [NSXTProperty(IsRequired: true, Description: @"The symbolic org id for GSS (Global Support Services).")]
        [System.ComponentModel.DataAnnotations.Required]
        ...
        [NSXTProperty(IsRequired: true, Description: @"Protocol and domain name (or IP address) of CSP, for e.g., https://console.cloud.vmware.com.")]
        [System.ComponentModel.DataAnnotations.Required]
