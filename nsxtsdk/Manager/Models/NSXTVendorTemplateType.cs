...
namespace nsxtsdk.ManagerModels
{
    ...
    public class NSXTVendorTemplateType : NSXTManagedResourceType
    {
        ...
        [NSXTProperty(IsRequired: false, Description: @"Different VMs in data center can have Different protection levels as specified by administrator in the policy. The identifier for the policy with which the partner appliance identifies this policy. This identifier will be passed to the partner appliance at runtime to specify which protection level is applicable for the VM being protected.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"List of attributes specific to a partner for which the vendor template is created. There attributes are passed on to the partner appliance and is opaque to the NSX Manager. Attributes are not supported by guest introspection service.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"The service to which the vendor template belongs.")]
