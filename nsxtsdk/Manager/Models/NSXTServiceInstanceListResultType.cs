...
namespace nsxtsdk.ManagerModels
{
    ...
    {
        public NSXTServiceInstanceListResultType()
        {
        }
        /// <summary>
        ...
        [NSXTProperty(IsRequired: false, Description: @"List of the Service-Insertion ServicesInstances. The list has to be homogenous.")]
