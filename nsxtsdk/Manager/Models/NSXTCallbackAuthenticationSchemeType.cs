...
namespace nsxtsdk.ManagerModels
{
    ...
    public class NSXTCallbackAuthenticationSchemeType 
    {
        ...
        [NSXTProperty(IsRequired: true, Description: @"Authentication scheme to use when making notification requests to the partner console. Specify one of BASIC_AUTH or CERTIFICATE.")]
