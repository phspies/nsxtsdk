...
namespace nsxtsdk.ManagerModels
{
    ...
    public class NSXTInstanceEndpointType : NSXTManagedResourceType
    {
        ...
        [NSXTProperty(IsRequired: false, Description: @"Id(s) of the Service Attachment where this enndpoint is connected to. Service Attachment is mandatory for LOGICAL Instance Endpoint.")]
        ...
        [NSXTProperty(IsRequired: true, Description: @"Target IPs on an interface of the Service Instance.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"The Service instancee with which the instance endpoint is associated.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Link Ids are mandatory for VIRTUAL Instance Endpoint. Even though VIRTUAL, the Instance Endpoint should be connected/accessible through an NSX object. The link id is this NSX object id. Example - For North-South Service Insertion, this is the LogicalRouter Id through which the targetIp/L3 destination accessible.")]
