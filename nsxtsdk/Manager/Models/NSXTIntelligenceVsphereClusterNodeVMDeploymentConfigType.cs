...
namespace nsxtsdk.ManagerModels
{
    ...
    public class NSXTIntelligenceVsphereClusterNodeVMDeploymentConfigType : NSXTIntelligenceClusterNodeVMDeploymentConfigType
    {
        ...
        [NSXTProperty(IsRequired: false, Description: @"The NSX-Intelligence cluster node VM OVF URL to download and install the OVF file.This field is deprecated now. Please upload OVA file using &quot;/repository/bundles&quot; APIand then try deployment without providing this field.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Desired display name for NSX-Intelligence VM to be deployed")]
        ...
        [NSXTProperty(IsRequired: true, Description: @"Distributed portgroup identifier to which the management vnic ofNSX-Intelligence cluster node VM will be connected.")]
        ...
        [NSXTProperty(IsRequired: true, Description: @"The NSX-Intelligence cluster node VM will be deployed on the specified cluster orresourcepool for specified VC server.")]
        [System.ComponentModel.DataAnnotations.Required]
        ...
        [NSXTProperty(IsRequired: true, Description: @"The NSX-Intelligence cluster node VM will be deployed on the specified datastore inthe specified VC server. User must ensure that storage is accessibleby the specified cluster/host.")]
        [System.ComponentModel.DataAnnotations.Required]
        ...
        [NSXTProperty(IsRequired: false, Description: @"The NSX-Intelligence cluster node VM will be deployed on the specified host in thespecified VC server within the cluster if host_id is specified.Note: User must ensure that storage and specified networks areaccessible by this host.")]
