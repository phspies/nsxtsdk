...
namespace nsxtsdk.ManagerModels
{
    ...
    public class NSXTEdgeClusterType : NSXTManagedResourceType
    {
        ...
        [NSXTProperty(IsRequired: false, Description: @"Edge cluster is homogenous collection of transport nodes.Hence all transport nodes of the cluster must be of same type.This readonly field shows the type of transport nodes.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"EdgeCluster only supports homogeneous members.These member should be backed by either EdgeNode or PublicCloudGatewayNode.TransportNode type of these nodes should be the same.DeploymentType (VIRTUAL_MACHINE|PHYSICAL_MACHINE) of these EdgeNodes isrecommended to be the same. EdgeCluster supports members of differentdeployment types.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"List of remote tunnel endpoint ipaddress configured on edge cluster for each transport node.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Edge cluster profile bindings")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Flag should be only use in federation for inter site l2 and l3 forwarding.Before enabling this flag, all the edge cluster members must have remotetunnel endpoint configured. TIER0/TIER1 logical routers managed by GMmust be associated with edge cluster which has inter-site forwardingenabled.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Set of allocation rules and respected action for auto placement oflogical router, DHCP and MDProxy on edge cluster members.")]
