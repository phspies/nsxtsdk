...
namespace nsxtsdk.ManagerModels
{
    ...
    public class NSXTAxesType 
    {
        ...
        [NSXTProperty(IsRequired: false, Description: @"A list of Y-Axis Labels with condition support. If needed, this property can be used to provide a list of y-axis label with condition support. For a label with single condition,&apos;y-label&apos; property can be used.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"A list of Y-Axis unit Labels with condition support. If needed, this property can be used to provide a list of y-axis unit label with condition support. This unit label can be used to display the point value along with units like percentage, milliseconds etc.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"A list of X-Axis Labels with condition support. If needed, this property can be used to provide a list of x-axis label with condition support. For a label with single condition,&apos;x-label&apos; property can be used.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"A list of Y-Axis unit with condition support. If needed, this property can be used to provide a list of y-axis unit with condition support. This unit could be like percentage, seconds, milliseconds etc.")]
