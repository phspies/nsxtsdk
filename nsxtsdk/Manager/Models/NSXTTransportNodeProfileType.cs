...
namespace nsxtsdk.ManagerModels
{
    ...
    public class NSXTTransportNodeProfileType : NSXTManagedResourceType
    {
        ...
        [NSXTProperty(IsRequired: false, Description: @"The HostSwitchSpec is the base class for standard and preconfiguredhost switch specifications. Only standard host switches are supportedin the transport node profile.")]
