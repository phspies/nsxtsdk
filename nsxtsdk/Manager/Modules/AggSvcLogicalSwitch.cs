...
namespace nsxtapi.ManagerModules
{
    public class AggSvcLogicalSwitch
    {
        ...
        public NSXTMacAddressCsvListResultType GetLogicalSwitchMacTableInCsvFormatCsv(string LswitchId, string? Source = null, string? TransportNodeId = null)
        {
            ...
            if (response.StatusCode != HttpStatusCode.OK)
			{
                var message = "HTTP GET operation to " + GetLogicalSwitchMacTableInCsvFormatCsvServiceURL.ToString() + " did not complete successfull";
                throw new NSXTException(message, (int)response.StatusCode, response.Content,  response.Headers, null);
			}
            else
			{
        ...
        public NSXTVtepCsvListResultType GetLogicalSwitchVtepTableInCsvFormatCsv(string LswitchId, string? Source = null, string? TransportNodeId = null)
        {
            ...
            if (response.StatusCode != HttpStatusCode.OK)
			{
                var message = "HTTP GET operation to " + GetLogicalSwitchVtepTableInCsvFormatCsvServiceURL.ToString() + " did not complete successfull";
                throw new NSXTException(message, (int)response.StatusCode, response.Content,  response.Headers, null);
			}
            else
			{
