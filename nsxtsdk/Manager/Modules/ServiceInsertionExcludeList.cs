...
namespace nsxtapi.ManagerModules
{
    public class ServiceInsertionExcludeList
    {
        ...
        public ServiceInsertionExcludeList(RestClient Client, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
            retry = _retry;
            timeout = _timeout;
        ...
        public async Task<NSXTSIExcludeListType> UpdateServiceInsertionExcludeList(NSXTSIExcludeListType SiexcludeList)
        {
            ...
            request.AddJsonBody(SiexcludeList);
            request.Resource = UpdateServiceInsertionExcludeListServiceURL.ToString();
            RestResponse<NSXTSIExcludeListType> response = await restClient.ExecuteTaskAsyncWithPolicy<NSXTSIExcludeListType>(request, cancellationToken, timeout, retry);
            if (response.StatusCode != HttpStatusCode.OK)
			{
