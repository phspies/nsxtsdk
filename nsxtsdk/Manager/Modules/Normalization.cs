...
namespace nsxtapi.ManagerModules
{
    public class Normalization
    {
        ...
        public Normalization(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
        ...
        public async Task<NSXTNormalizedResourceListResultType> GetNormalizations(string PreferredNormalizationType, string ResourceId, string ResourceType, string? Cursor = null, string? IncludedFields = null, long? PageSize = null, bool? SortAscending = null, string? SortBy = null)
        {
            ...
            IRestResponse<NSXTNormalizedResourceListResultType> response = await restClient.ExecuteTaskAsyncWithPolicy<NSXTNormalizedResourceListResultType>(request, cancellationToken, timeout, retry);
