...
namespace nsxtapi.PolicyModules
{
    public class PolicySiteOffboarding
    {
        ...
        public PolicySiteOffboarding(RestClient Client, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
            retry = _retry;
            timeout = _timeout;
        ...
        public async Task<NSXTSiteOffBoardingStateType> GetSiteOffboardingStatus()
        {
            ...
            RestResponse<NSXTSiteOffBoardingStateType> response = await restClient.ExecuteTaskAsyncWithPolicy<NSXTSiteOffBoardingStateType>(request, cancellationToken, timeout, retry);
