...
namespace nsxtapi.PolicyModules
{
    public class PolicyHostTransportNodeProfile
    {
        ...
        public PolicyHostTransportNodeProfile(RestClient Client, CancellationToken _cancellationToken, int _timeout, int _retry)
        {
            restClient = Client;
            retry = _retry;
            timeout = _timeout;
        ...
        public async Task<NSXTPolicyHostTransportNodeProfileListResultType> ListPolicyHostTransportNodeProfiles(string? Cursor = null, string? IncludedFields = null, long? PageSize = null, bool? SortAscending = null, string? SortBy = null)
        {
            ...
            RestResponse<NSXTPolicyHostTransportNodeProfileListResultType> response = await restClient.ExecuteTaskAsyncWithPolicy<NSXTPolicyHostTransportNodeProfileListResultType>(request, cancellationToken, timeout, retry);
        ...
        public async Task<NSXTPolicyHostTransportNodeProfileType> CreateOrUpdatePolicyHostTransportNodeProfile(string TransportNodeProfileId, NSXTPolicyHostTransportNodeProfileType PolicyHostTransportNodeProfile)
        {
            ...
            request.AddJsonBody(PolicyHostTransportNodeProfile);
            request.Resource = CreateOrUpdatePolicyHostTransportNodeProfileServiceURL.ToString();
            RestResponse<NSXTPolicyHostTransportNodeProfileType> response = await restClient.ExecuteTaskAsyncWithPolicy<NSXTPolicyHostTransportNodeProfileType>(request, cancellationToken, timeout, retry);
            if (response.StatusCode != HttpStatusCode.OK)
			{
