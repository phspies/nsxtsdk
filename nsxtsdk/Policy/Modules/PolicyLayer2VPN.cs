...
namespace nsxtapi.PolicyModules
{
    public class PolicyLayer2VPN
    {
        ...
        public PolicyLayer2VPN(RestClient Client, JsonSerializerSettings DefaultSerializationSettings, CancellationToken _cancellationToken, int _timeout, int _retry)
