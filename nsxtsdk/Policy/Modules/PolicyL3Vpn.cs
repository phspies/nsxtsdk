...
namespace nsxtapi.PolicyModules
{
    public class PolicyL3Vpn
    {
        ...
        /// </summary>
        [NSXTProperty(Description: @"")]
        public NSXTL3VpnType GlobalCreateOrReplaceL3Vpn(string Tier0Id, string LocaleServiceId, string L3vpnId, NSXTL3VpnType L3Vpn)
        {
            if (Tier0Id == null) { throw new System.ArgumentNullException("Tier0Id cannot be null"); }
            if (LocaleServiceId == null) { throw new System.ArgumentNullException("LocaleServiceId cannot be null"); }
            if (L3vpnId == null) { throw new System.ArgumentNullException("L3vpnId cannot be null"); }
            ...
            StringBuilder CreateOrReplaceL3VpnServiceURL = new StringBuilder("/global-infra/tier-0s/{tier-0-id}/locale-services/{locale-service-id}/l3vpns/{l3vpn-id}");
            var request = new RestRequest
            {              
                RequestFormat = DataFormat.Json,
                Method = Method.PUT
        ...
        /// </summary>
        [NSXTProperty(Description: @"")]
        public void GlobalDeleteL3Vpn(string Tier0Id, string LocaleServiceId, string L3vpnId)
        {
            if (Tier0Id == null) { throw new System.ArgumentNullException("Tier0Id cannot be null"); }
            if (LocaleServiceId == null) { throw new System.ArgumentNullException("LocaleServiceId cannot be null"); }
            if (L3vpnId == null) { throw new System.ArgumentNullException("L3vpnId cannot be null"); }
            
            StringBuilder DeleteL3VpnServiceURL = new StringBuilder("/global-infra/tier-0s/{tier-0-id}/locale-services/{locale-service-id}/l3vpns/{l3vpn-id}");
            var request = new RestRequest
            {              
                RequestFormat = DataFormat.Json,
        ...
        /// </summary>
        [NSXTProperty(Description: @"")]
        public NSXTL3VpnType GlobalReadL3Vpn(string Tier0Id, string LocaleServiceId, string L3vpnId)
        {
            if (Tier0Id == null) { throw new System.ArgumentNullException("Tier0Id cannot be null"); }
            if (LocaleServiceId == null) { throw new System.ArgumentNullException("LocaleServiceId cannot be null"); }
            if (L3vpnId == null) { throw new System.ArgumentNullException("L3vpnId cannot be null"); }
            NSXTL3VpnType returnValue = default(NSXTL3VpnType);
            StringBuilder ReadL3VpnServiceURL = new StringBuilder("/global-infra/tier-0s/{tier-0-id}/locale-services/{locale-service-id}/l3vpns/{l3vpn-id}");
            var request = new RestRequest
            {              
                RequestFormat = DataFormat.Json,
                Method = Method.GET
        ...
        /// </summary>
        [NSXTProperty(Description: @"")]
        public void GlobalCreateOrPatchL3Vpn(string Tier0Id, string LocaleServiceId, string L3vpnId, NSXTL3VpnType L3Vpn)
        {
            if (Tier0Id == null) { throw new System.ArgumentNullException("Tier0Id cannot be null"); }
            if (LocaleServiceId == null) { throw new System.ArgumentNullException("LocaleServiceId cannot be null"); }
            if (L3vpnId == null) { throw new System.ArgumentNullException("L3vpnId cannot be null"); }
            ...
            StringBuilder CreateOrPatchL3VpnServiceURL = new StringBuilder("/global-infra/tier-0s/{tier-0-id}/locale-services/{locale-service-id}/l3vpns/{l3vpn-id}");
            var request = new RestRequest
            {              
                RequestFormat = DataFormat.Json,
                Method = Method.PATCH
        ...
        /// </summary>
        [NSXTProperty(Description: @"")]
        public NSXTL3VpnType ReadL3VpnWithSensitiveDataShowSensitiveData(string Tier0Id, string LocaleServiceId, string L3vpnId)
        {
            if (Tier0Id == null) { throw new System.ArgumentNullException("Tier0Id cannot be null"); }
            if (LocaleServiceId == null) { throw new System.ArgumentNullException("LocaleServiceId cannot be null"); }
            if (L3vpnId == null) { throw new System.ArgumentNullException("L3vpnId cannot be null"); }
            NSXTL3VpnType returnValue = default(NSXTL3VpnType);
            StringBuilder ReadL3VpnWithSensitiveDataShowSensitiveDataServiceURL = new StringBuilder("/infra/tier-0s/{tier-0-id}/locale-services/{locale-service-id}/l3vpns/{l3vpn-id}?action=show_sensitive_data");
            var request = new RestRequest
            {              
                RequestFormat = DataFormat.Json,
                Method = Method.GET
            ...
            request.AddHeader("Content-type", "application/json");
            ReadL3VpnWithSensitiveDataShowSensitiveDataServiceURL.Replace("{tier-0-id}", System.Uri.EscapeDataString(Helpers.ConvertToString(Tier0Id, System.Globalization.CultureInfo.InvariantCulture)));
            ReadL3VpnWithSensitiveDataShowSensitiveDataServiceURL.Replace("{locale-service-id}", System.Uri.EscapeDataString(Helpers.ConvertToString(LocaleServiceId, System.Globalization.CultureInfo.InvariantCulture)));
            ReadL3VpnWithSensitiveDataShowSensitiveDataServiceURL.Replace("{l3vpn-id}", System.Uri.EscapeDataString(Helpers.ConvertToString(L3vpnId, System.Globalization.CultureInfo.InvariantCulture)));
            request.Resource = ReadL3VpnWithSensitiveDataShowSensitiveDataServiceURL.ToString();
            var response = restClient.Execute(request);
            if (response.StatusCode != HttpStatusCode.OK)
			{
                var message = "HTTP GET operation to " + ReadL3VpnWithSensitiveDataShowSensitiveDataServiceURL.ToString() + " did not complete successfull";
                throw new NSXTException(message, (int)response.StatusCode, response.Content,  response.Headers, null);
			}
            else
			{
        ...
        /// </summary>
        [NSXTProperty(Description: @"")]
        public NSXTL3VpnListResultType GlobalListL3Vpns(string Tier0Id, string LocaleServiceId, string? Cursor = null, bool? IncludeMarkForDeleteObjects = null, string? IncludedFields = null, string? L3vpnSession = null, long? PageSize = null, bool? SortAscending = null, string? SortBy = null)
        {
            if (Tier0Id == null) { throw new System.ArgumentNullException("Tier0Id cannot be null"); }
            if (LocaleServiceId == null) { throw new System.ArgumentNullException("LocaleServiceId cannot be null"); }
            NSXTL3VpnListResultType returnValue = default(NSXTL3VpnListResultType);
            StringBuilder ListL3VpnsServiceURL = new StringBuilder("/global-infra/tier-0s/{tier-0-id}/locale-services/{locale-service-id}/l3vpns");
            var request = new RestRequest
            {              
                RequestFormat = DataFormat.Json,
                Method = Method.GET
        ...
        /// </summary>
        [NSXTProperty(Description: @"")]
        public NSXTL3VpnType GlobalReadL3VpnWithSensitiveDataShowSensitiveData(string Tier0Id, string LocaleServiceId, string L3vpnId)
        {
            if (Tier0Id == null) { throw new System.ArgumentNullException("Tier0Id cannot be null"); }
            if (LocaleServiceId == null) { throw new System.ArgumentNullException("LocaleServiceId cannot be null"); }
            if (L3vpnId == null) { throw new System.ArgumentNullException("L3vpnId cannot be null"); }
            NSXTL3VpnType returnValue = default(NSXTL3VpnType);
            StringBuilder ReadL3VpnWithSensitiveDataShowSensitiveDataServiceURL = new StringBuilder("/global-infra/tier-0s/{tier-0-id}/locale-services/{locale-service-id}/l3vpns/{l3vpn-id}?action=show_sensitive_data");
            var request = new RestRequest
            {              
                RequestFormat = DataFormat.Json,
                Method = Method.GET
        ...
        /// </summary>
        [NSXTProperty(Description: @"")]
        public NSXTL3VpnContextType GlobalReadL3VpnContext(string Tier0Id, string LocaleServiceId)
        {
            if (Tier0Id == null) { throw new System.ArgumentNullException("Tier0Id cannot be null"); }
            if (LocaleServiceId == null) { throw new System.ArgumentNullException("LocaleServiceId cannot be null"); }
            NSXTL3VpnContextType returnValue = default(NSXTL3VpnContextType);
            StringBuilder ReadL3VpnContextServiceURL = new StringBuilder("/global-infra/tier-0s/{tier-0-id}/locale-services/{locale-service-id}/l3vpn-context");
            var request = new RestRequest
            {              
                RequestFormat = DataFormat.Json,
                Method = Method.GET
        ...
        /// </summary>
        [NSXTProperty(Description: @"")]
        public string GlobalReadL3VpnPeerConfig(string Tier0Id, string LocaleServiceId, string L3vpnId, string? EnforcementPointPath = null)
        {
            if (Tier0Id == null) { throw new System.ArgumentNullException("Tier0Id cannot be null"); }
            if (LocaleServiceId == null) { throw new System.ArgumentNullException("LocaleServiceId cannot be null"); }
            if (L3vpnId == null) { throw new System.ArgumentNullException("L3vpnId cannot be null"); }
            string returnValue  = default(string);
            StringBuilder ReadL3VpnPeerConfigServiceURL = new StringBuilder("/global-infra/tier-0s/{tier-0-id}/locale-services/{locale-service-id}/l3vpns/{l3vpn-id}/peer-config");
            var request = new RestRequest
            {              
                RequestFormat = DataFormat.Json,
                Method = Method.GET
