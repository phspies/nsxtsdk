...
namespace nsxtsdk.PolicyModels
{
    ...
    public class NSXTALBHttpCacheConfigType 
    {
        ...
        [NSXTProperty(IsRequired: false, Description: @"Blocklist of non-cacheable mime types.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Allowlist string group of cacheable mime types.If both Cacheable Mime Types string list and string groupare empty, this defaults to (STAR)/(STAR).It is a reference to an object of type StringGroup.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Allowlist of cacheable mime types.If both Cacheable Mime Types string list and string groupare empty, this defaults to (STAR)/(STAR).")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Enable/disable HTTP object caching.When enabling cachingfor the first time, SE Group app_cache_percent must be setto allocate shared memory required for caching (A serviceengine restart is needed after setting/resetting the SEgroup value).Default value when not specified in API or module isinterpreted by ALB Controller as false.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Blocklist string group of non-cacheable mime types.It is a reference to an object of type StringGroup.")]
