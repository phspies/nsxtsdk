...
namespace nsxtsdk.PolicyModels
{
    ...
    public class NSXTALBSSLKeyAndCertificateType : NSXTPolicyConfigResourceType
    {
        ...
        [NSXTDefaultProperty(Default: "SSL_CERTIFICATE_FINISHED")]
        ...
        [NSXTProperty(IsRequired: true, Description: @"Placeholder for description of property certificate of objtype SSLKeyAndCertificate field type str  type ref.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Configuration related to OCSP.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Placeholder for description of property key_params of objtype SSLKeyAndCertificate field type str  type ref.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Enables OCSP Stapling.Default value when not specified in API or module isinterpreted by ALB Controller as false.")]
        ...
        [NSXTDefaultProperty(Default: "SSL_PEM")]
