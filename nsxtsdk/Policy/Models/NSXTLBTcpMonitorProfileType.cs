...
namespace nsxtsdk.PolicyModels
{
    ...
    public class NSXTLBTcpMonitorProfileType : NSXTLBActiveMonitorType
    {
        ...
        [NSXTProperty(IsRequired: false, Description: @"Expected data, if specified, can be anywhere in the response and it hasto be a string, regular expressions are not supported.")]
