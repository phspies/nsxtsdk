...
namespace nsxtsdk.PolicyModels
{
    ...
    public class NSXTALBSSLVersionType 
    {
        ...
        [NSXTProperty(IsRequired: true, Description: @"Enum options - SSL_VERSION_SSLV3, SSL_VERSION_TLS1,SSL_VERSION_TLS1_1, SSL_VERSION_TLS1_2, SSL_VERSION_TLS1_3.Default value when not specified in API or module isinterpreted by ALB Controller as SSL_VERSION_TLS1_1.")]
        [System.ComponentModel.DataAnnotations.Required]
        [NSXTDefaultProperty(Default: "SSL_VERSION_TLS1_1")]
