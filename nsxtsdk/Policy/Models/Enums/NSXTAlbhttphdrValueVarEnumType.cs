...
namespace nsxtsdk.PolicyModels
{
    ...
    public enum NSXTAlbhttphdrValueVarEnumType
    {
        ...
        [EnumMember(Value = "HTTP_POLICY_VAR_SSL_CLIENT_VERSION")]
        HTTPPOLICYVARSSLCLIENTVERSION = 15,
        [EnumMember(Value = "HTTP_POLICY_VAR_SSL_CLIENT_SIGALG")]
        HTTPPOLICYVARSSLCLIENTSIGALG = 16,
        [EnumMember(Value = "HTTP_POLICY_VAR_SSL_CLIENT_NOTVALIDBEFORE")]
        HTTPPOLICYVARSSLCLIENTNOTVALIDBEFORE = 17,
        [EnumMember(Value = "HTTP_POLICY_VAR_SSL_CLIENT_NOTVALIDAFTER")]
        HTTPPOLICYVARSSLCLIENTNOTVALIDAFTER = 18,
    }
}
