...
namespace nsxtsdk.PolicyModels
{
    ...
    /// </summary>
    [NSXTProperty(Description: @"Override the waf mode for this rule.Enum options - WAF_MODE_DETECTION_ONLY,WAF_MODE_ENFORCEMENT.")]
    public enum NSXTAlbwafRuleOverridesModeEnumType
    {
