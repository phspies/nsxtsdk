...
namespace nsxtsdk.PolicyModels
{
    ...
    public class NSXTRedirectionPolicyType : NSXTPolicyType
    {
        ...
        [NSXTProperty(IsRequired: false, Description: @"Redirection rules that are a part of this RedirectionPolicy. Atmax, there can be 1000 rules in a given RedirectPolicy.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"This is the read only flag which will state the direction of this |redirection policy. True denotes that it is NORTH-SOUTH and false |value means it is an EAST-WEST redirection policy.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Paths to which traffic will be redirected to. As of now, only 1 is |supported. Paths allowed are |1. Policy Service Instance |2. Service Instance Endpoint |3. Virtual Endpoint |4. Policy Service Chain")]
