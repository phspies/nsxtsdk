...
namespace nsxtsdk.PolicyModels
{
    ...
    public class NSXTDirectoryDomainSyncStatsType 
    {
        ...
        [NSXTProperty(IsRequired: false, Description: @"Directory domain previous sync status. It could be one of the following two states.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"All the historical full sync are counted in calculating the average full sync time in milliseconds.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Directory domain previous sync type. It could be one of the following five states. Right after the directory domain is configured, this field is set to IDLE.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"number of successful historical full sync initiated either by system or by API request.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Since what time the current state has begun. The time is expressed in millisecond epoch time.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"All the historical delta sync are counted in calculating the average delta sync time in milliseconds.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Directory domain previous sync status error if last status was failure.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Current running state of the directory domain in synchronization life cycle. It could be one of the following five states. SELECTIVE_FULL_SYNC and SELECTIVE_DELTA_SYNC are sync states for selective sync.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"number of successful historical delta sync initiated either by system or by API request.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Directory domain previous sync ending time expressed in millisecond epoch time.")]
