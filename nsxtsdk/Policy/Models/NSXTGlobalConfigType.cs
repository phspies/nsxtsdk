...
namespace nsxtsdk.PolicyModels
{
    ...
    {
        public NSXTGlobalConfigType()
        {
            VdrMacNested = test
            PhysicalUplinkMtu = test
            UplinkMtuThreshold = test
            L3ForwardingMode = test
            VdrMac = test
            RemoteTunnelPhysicalMtu = test
        }
        /// <summary>
        ...
        [NSXTProperty(IsRequired: false, Description: @"This property is a part of OpsGlobalConfig object. Use /infra/ops-global-config instead.The VRNI and WAVE_FRONT collector type can be defined to collect the metric data.The WAVE_FRONT collector type can only be used in VMC mode.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Flag to enable/disable ECMP load balancing.By default ECMP load balancing is disabled.")]
