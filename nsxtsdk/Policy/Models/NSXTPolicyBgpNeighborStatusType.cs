...
namespace nsxtsdk.PolicyModels
{
    ...
    public class NSXTPolicyBgpNeighborStatusType 
    {
        ...
        [NSXTProperty(IsRequired: false, Description: @"Policy path to Tier0")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"If a HELLO packet is not seen from BGP Peer withing hold_timethen BGP neighbor will be marked as down.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Transport node policy path")]
