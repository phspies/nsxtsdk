...
namespace nsxtsdk.PolicyModels
{
    ...
    public class NSXTALBDnsQueryTypeMatchType 
    {
        ...
        [NSXTProperty(IsRequired: true, Description: @"Criterion to use for matching the DNS query typein thequestion section.Enum options - IS_IN, IS_NOT_IN.")]
