...
namespace nsxtsdk.PolicyModels
{
    ...
    {
        public NSXTInfraSecurityConfigType()
        {
        }
        /// <summary>
        ...
        [NSXTProperty(IsRequired: false, Description: @"When this flag is set to true, during certificate checking the CRL is fetched and checked whether the certificate is revoked or not.  Setting this property to false results in lower security.  It is not advisible to import certificate without CRL info while CRL checking is disabled, and then re-enable CRL checking.")]
