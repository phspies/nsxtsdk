...
namespace nsxtsdk.PolicyModels
{
    ...
    {
        public NSXTPolicyPoolUsageType()
        {
        }
        /// <summary>
        ...
        [NSXTProperty(IsRequired: false, Description: @"Total number of requested IP allocations in a IpAddressPool")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Total number of allocated IPs shown are from NSX manager.NSX manager uses default release delay of 2 mins. Till this delay passes,IPs will be shown as allocated (and counted in allocated ips).In this period of time there could be mismatch in requested_ip_allocationsand allocated_ip_allocations.")]
        ...
        [NSXTProperty(IsRequired: false, Description: @"Total number of available IPs in a IpAddressPool")]
        public long? AvailableIps { get; set; }
        /// <summary>
        /// Total number of IPs in a IpAddressPool
        /// </summary>
        [JsonProperty(PropertyName = "total_ips")]
        [NSXTProperty(IsRequired: false, Description: @"Total number of IPs in a IpAddressPool")]
